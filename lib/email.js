...
<html lang="en">
          ...
          <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="max-width:700px; background:#ffffff; border-radius:24px; overflow:hidden; border:1px solid #ded7cc; box-shadow:0 24px 58px rgba(20, 26, 36, 0.08);">
            ...
            <tr>
              <td style="padding:22px 34px 34px;">
                ...
                <p style="margin:18px 0 0; color:#6f7784; font-size:15px; line-height:1.6;">For more content and self improvement, check out more videos: <a href="${CHANNEL_URL}" style="color:#111825; font-weight:800; text-decoration:underline;">YouTube</a></p>
              </td>
            </tr>
          </table>
        </td>
  ...
  const text = [
    ...
    "- Zane",
    "",
    "For more content and self improvement, check out more videos:",
    CHANNEL_URL
  ].join("\n");
