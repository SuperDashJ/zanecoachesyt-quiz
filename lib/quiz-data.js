export const quizSteps = [
  ...
  },
  {
    ...
    cardStyle: "score",
    options: [
      { id: "1", label: "1", imageSrc: "/quiz-assets/crops/status-1.png" },
      { id: "2", label: "2", imageSrc: "/quiz-assets/crops/status-2.png" },
      { id: "3", label: "3", imageSrc: "/quiz-assets/crops/status-3.png" },
      { id: "4", label: "4", imageSrc: "/quiz-assets/crops/status-4.png" },
      { id: "5", label: "5", imageSrc: "/quiz-assets/crops/status-5.png" },
      {
        id: "skip",
  ...
  },
  {
    ...
    options: [
      { id: "screen", label: "Screen", imageSrc: "/quiz-assets/9.png" },
      { id: "quitting", label: "I keep quitting", imageSrc: "/quiz-assets/crops/blocker-quitting.png" },
      {
        id: "no-main-thing",
        label: "I don’t have one main thing",
        imageSrc: "/quiz-assets/crops/blocker-no-main-thing.png"
      },
      {
        id: "too-much",
        label: "I’m trying to do too much",
        imageSrc: "/quiz-assets/crops/blocker-too-much.png"
      },
      { id: "no-preference", label: "No preference", imageSrc: "/quiz-assets/crops/blocker-no-preference.png" }
    ]
  },
  {
    id: "pain",
    ...
    options: [
      { id: "screens", label: "Screens", imageSrc: "/quiz-assets/9.png" },
      { id: "junk-food", label: "Junk food", imageSrc: "/quiz-assets/11.png" },
      {
        id: "lack-of-motivation",
        label: "Lack of motivation",
        imageSrc: "/quiz-assets/10.png"
      }
    ]
  },
  {
    ...
    options: [
      { id: "huge-reset", label: "Huge reset", imageSrc: "/quiz-assets/crops/change-huge-reset.png" },
      { id: "small-habits", label: "Small habits", imageSrc: "/quiz-assets/crops/change-small-habits.png" },
      { id: "balanced-change", label: "Balanced change", imageSrc: "/quiz-assets/crops/change-balanced.png" }
    ]
  },
  {
    id: "time-budget",
    ...
    artMinHeightMobile: 92,
    options: [
      { id: "5-minutes", label: "5 minutes", imageSrc: "/quiz-assets/crops/time-5.png" },
      { id: "15-minutes", label: "15 minutes", imageSrc: "/quiz-assets/crops/time-15.png" },
      { id: "30-plus-minutes", label: "30+ minutes", imageSrc: "/quiz-assets/crops/time-30.png" },
      {
        id: "skip",
        label: "I’m not sure. Let’s skip it.",
        imageSrc: "/quiz-assets/crops/time-skip.png"
      }
    ]
  },
  {
