...
function buildFocusTrack(priority, fastestImprovement) {
  if (priority === "money" || fastestImprovement === "making-more-money") {
    return "Money track";
  }

  if (priority === "fitness" || fastestImprovement === "better-shape-social-skills") {
...
function buildFastestWin(fastestImprovement) {
  switch (fastestImprovement) {
    case "making-more-money":
      return "One daily money action will create the fastest visible change in your confidence and options.";
    case "better-shape-social-skills":
      return "Improving your body and confidence will create fast spillover into energy, mood, and presence.";
...
function buildWeekOneChecklist(answers) {
  ...
  if (answers["fastest-improvement"] === "making-more-money") {
    items.push("Create one measurable money target for this week.");
  } else if (answers["fastest-improvement"] === "better-shape-social-skills") {
    items.push("Schedule one workout and one confidence-building social rep this week.");
